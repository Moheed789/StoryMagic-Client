            ...
            {subscriptionStatus ? (
              <article className="mt-6 rounded-[20px] bg-[#F4F2F7] border border-[#E7E4EC] py-6 px-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-2 text-[#666] text-sm">
                    <span
                      className="inline-flex h-2.5 w-2.5 rounded-full bg-[#34C759]"
                      aria-hidden="true"
                    />
                    <span>Active</span>
                  </div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <div className="text-[40px] leading-none font-extrabold tracking-tight text-[#8C5AF2]">
                      $9.00
                    </div>
                ...
                <h3 className="mt-3 text-[28px] sm:text-[32px] font-[700] text-[#141217]">
                  Pro Plan
                </h3>
                ...
                <p className="mt-3 text-sm text-[#7A5AF8]">
                  You're currently using the Pro plan
                </p>
              ...
              <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <article
                  ...
                  style={{
                    background:
                      "linear-gradient(145deg, #7C4DFF 0%, #F0B429 100%)",
                  }}
                >
                  <p className="text-[18px] font-[700] text-[#FDF4C8]">
                    Pro Plan
                  </p>

                  <div className="mt-3 flex items-baseline gap-2">
                    <div className="text-[40px] leading-none font-extrabold tracking-tight">
                      $9.00
                    </div>
                  ...
                  <p className="mt-2 text-[13px] text-white/90">
                    Unlimited stories for serious creators.
                  </p>
