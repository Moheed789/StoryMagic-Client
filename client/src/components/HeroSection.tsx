  ...
  const steps = [
    {
      ...
      description:
        "Tell us about the story you want to create through our chat interface",
    },
    {
      icon: BookOpenIcon,
    ...
    },
    {
      ...
      title: "Download Book",
      description:
        "Get your finished storybook as a PDF or order a printed copy",
    },
  ];
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-lg">
              ...
              <p className="text-lg text-muted-foreground mb-6 font-story">
                Bring your child's imagination to life with AI-powered
                storytelling and beautiful illustrations. Create personalized
                storybooks in minutes!
              </p>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground font-story">
            Creating your child's dream storybook is easy with our 4-step
            process
          </p>
        </div>
