...
const BookCustomizationModal: React.FC<BookCustomizationModalProps> = ({
  ...
  // ✅ Checkout with phone number included
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2 bg-slate-50 w-full">
                  ...
                  <div className="text-[12px] md:text-sm text-slate-700 flex-1">
                    United States
                  </div>
                </div>
                <input
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] md:text-sm focus:outline-none focus:ring-2 focus:ring-[#8C5AF2]/40"
                />
...
//     console.log("📞 Sending phone number:", payload.shipping_address.phone_number);
//     console.log("📦 Final checkout payload:", payload);
