...
const UnlockPreviewsModal: React.FC<UnlockPreviewsModalProps> = ({
  ...
  const handleUnlockPreviews = async () => {
    try {
      ...
      if (!storyId) {
        toast({ title: "Error", description: "No story selected", variant: "destructive" });
        return;
      }
      ...
      if (checkoutUrl) {
        ...
        // Important. Do NOT mark as purchased now. Let verification do it after payment.
        window.location.href = checkoutUrl;
      } else {
